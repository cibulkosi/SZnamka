    ...
    <main className="min-h-screen bg-[#F0EBE3]">
      ...
      <article className="max-w-md mx-auto py-4 px-4 space-y-3">
        ...
        <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
          {/* Top: 2 horizontal pills (Věk | Znamení) */}
          <div className="grid grid-cols-2 divide-x divide-gray-100 border-b border-gray-100">
            <div className="px-3 py-4 flex items-center justify-center gap-2">
              {/* Birthday cake icon — clearer than the previous bag-like one */}
          ...
          {/* Bottom: archetype (featured with number) + occupation + city */}
          <div>
            <div className="flex items-center gap-4 px-5 py-3.5 border-b border-gray-100">
              <SaturnIcon size={22} />
              <span className="text-[0.95rem] text-gray-900">
                Životní číslo <span className="font-medium text-pink-600 tabular-nums">{profile.archetype.number}</span> — <span className="font-medium">{profile.archetype.name}</span>
              </span>
            </div>
            <div className="flex items-center gap-4 px-5 py-3.5 border-b border-gray-100">
