// trial-expiring — odešle se den 5 trialu (2 dny před vypršením). v2 — final copy 20. 5. 2026
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const html = emailLayout({
      ...
      body: `
        <p style="margin: 0 0 16px;">Před pěti dny ses připojil/a k Cosmatch a měl/a možnost si vyzkoušet <strong>Cosmatch+ na týden zdarma</strong> a poznat tak appku naplno.</p>
        ...
        <ul style="margin: 0 0 16px; padding-left: 20px; color: #374151;">
          ...
          <li style="margin-bottom: 8px;">máš neomezené lajky a zprávy (free účet má limit 5/den)</li>
          <li style="margin-bottom: 8px;">máš pět filtrů včetně záměru a vzdálenosti</li>
          <li style="margin-bottom: 8px;">máš častější zobrazení tvého profilu ve feedu ostatních</li>
        </ul>
        <p style="margin: 24px 0 16px; color: #6b7280; font-size: 14px;">Nebo stačí nedělat nic a vrátit se na free účet. Tvoje konverzace pokračují dál.</p>
      `,
      ctaUrl: 'https://cosmatch.cz/premium',
      ctaLabel: 'Pokračovat s Cosmatch+ za 249 Kč/měs',
    })

    const text = `${headingPrefix}v Cosmatch+ Ti zbývají ještě 2 dny.\n\nPřed pěti dny ses připojil/a k Cosmatch a měl/a možnost si vyzkoušet Cosmatch+ na týden zdarma.\n\nZa 2 dny ti trial končí. Potom se vrátíš na free účet.\n\nV Cosmatch+ teď:\n• detail kompatibility (Soulmate Wheel) u každého profilu\n• vidíš, kdo si tě lajknul, dřív než je ty\n• neomezené lajky a zprávy (free účet má limit 5/den)\n• pět filtrů včetně záměru a vzdálenosti\n• častější zobrazení tvého profilu ve feedu\n\nPokračovat s Cosmatch+: https://cosmatch.cz/premium\n\nNebo stačí nedělat nic a vrátit se na free účet. Tvoje konverzace pokračují dál.\n\ncosmatch.cz`
