...
export const ARCHETYPES: Record<number, Archetype> = {
  1: {
    ...
    description: 'Jsi archetyp Průkopníka — vůdce, který si razí svou vlastní cestu. Charakterizuje Tě nezávislost, kreativita a ambice.',
    traits: ['Sebejistý a rozhodný', 'Přirozený leader', 'Vytváříš originální nápady', 'Cílevědomý a vytrvalý'],
  ...
  2: {
    ...
    traits: ['Vysoká emoční inteligence', 'Skvělý posluchač', 'Intuitivní vnímání lidí', 'Trpělivý partner'],
    love: 'Jako Diplomat potřebuješ stabilního, milujícího partnera, který oceňuje Tvou citlivost. Nejlépe si rozumíš se 4 (Stavitel), 6 (Pečovatel), 9 (Idealista) díky kombinaci stability a hloubky.',
  ...
  3: {
    ...
    description: 'Jsi Tvůrce — kreativní vypravěč, který přitahuje pozornost. Jsi charismatický/á, expresivní a optimistický/á.',
    traits: ['Kreativní mysl', 'Skvělý komunikátor', 'Přirozený optimismus', 'Inspiruješ ostatní'],
    love: 'Jako Tvůrce potřebuješ partnera, který oceňuje Tvou energii a dává Ti prostor zářit. Nejlépe se hodíš k 1 (Průkopník), 5 (Dobrodruh), 7 (Hledač), s nimiž vytváříš energetická souznění.',
  ...
  4: {
    ...
    description: 'Jsi Stavitel — pragmatický stratég, který staví trvalé věci. Jsi spolehlivý/á a věrný/á milovník stability.',
    traits: ['Disciplinovaný a vytrvalý', 'Vysoce loajální', 'Praktický myslitel', 'Tvůrce systémů'],
    love: 'Jako Stavitel potřebuješ bezpečí a předvídatelnost. Nejlépe se hodíš k 2 (Diplomat), 6 (Pečovatel), 8 (Vůdce), s nimiž sdílíš hodnoty stability.',
  ...
  5: {
    ...
    description: 'Jsi Dobrodruh — svobodný duch, který se nudí rutinou. Jsi adaptivní, zvídavý/á a plný/á energie.',
    traits: ['Adaptabilní v každé situaci', 'Komunikativní a vtipný', 'Nadšení pro nové zkušenosti', 'Otevřená mysl'],
    love: 'Jako Dobrodruh potřebuješ prostor a dobrodružství. Ideální shoda: 1 (Průkopník), 3 (Tvůrce), 7 (Hledač) — partneři s vlastním světem.',
  ...
  6: {
    ...
    description: 'Jsi Pečovatel — láskyplný ochránce rodiny a svých přátel. Jsi zodpovědný/á, věrný/á a dáváš víc, než bereš.',
    traits: ['Vysoce empatický', 'Zodpovědný za druhé', 'Vytváříš harmonické prostředí', 'Loajální partner'],
    love: 'Jako Pečovatel potřebuješ partnera, který umí přijímat lásku stejně hluboce, jako ji dáváš. Ideální shoda: 1 (Průkopník), 2 (Diplomat), 9 (Idealista), kde najdeš kombinaci lásky, sdíleného soucitu a porozumění.',
  ...
  7: {
    ...
    description: 'Jsi Hledač (někdy nazývaný Mudrc) — introspektivní hledač pravdy. Jsi analytický/á, intuitivní a vidíš pod povrch věcí.',
    traits: ['Hluboká analytická mysl', 'Spirituální vhled', 'Nezávislý myslitel', 'Vyhledáváš moudrost'],
    love: 'Jako Hledač potřebuješ partnera, který respektuje Tvou potřebu ticha a dokáže vést smysluplné rozhovory. Ideální shoda: 3 (Tvůrce), 5 (Dobrodruh), 11 (Vizionář).',
  ...
  8: {
    ...
    description: 'Jsi Vůdce — ambiciózní stratég, který umí přeměnit vizi ve skutečnost. Jsi mocný/á, sebevědomý/á a orientovaný/á na výsledky.',
    traits: ['Silný leader', 'Strategický myslitel', 'Schopen vytvořit bohatství', 'Disciplinovaný'],
    love: 'Jako Vůdce potřebuješ rovnocenného partnera, ne obdivovatele. Ideální shoda: 2 (Diplomat), 4 (Stavitel), 6 (Pečovatel).',
  ...
  9: {
    ...
    description: 'Jsi Idealista — velkorysý vizionář, který cítí utrpení světa a chce ho měnit. Jsi soucitný/á a moudrý/á.',
    traits: ['Hluboká empatie', 'Globální vidění', 'Velkorysost', 'Inspiruješ ostatní k růstu'],
    love: 'Jako Idealista potřebuješ partnera, který sdílí stejné hodnoty. Ideální shoda: 1 (Průkopník), 2 (Diplomat), 3 (Tvůrce), u kterých najdeš souznění hodnot a vzájemný respekt.',
  ...
  11: {
    ...
    traits: ['Vysoce vyvinutá intuice', 'Inspiruješ k duchovnímu růstu', 'Telepatické vnímání', 'Léčivá energie'],
    love: 'Jako Vizionář potřebuješ hluboké duchovní spojení. Povrchní vztahy Tě vyčerpávají. Ideální shoda: 2 (Diplomat), 6 (Pečovatel), 9 (Idealista).',
  ...
  22: {
    ...
    traits: ['Vize plus exekuce', 'Schopen stavět ze snů reality', 'Disciplinovaný leader', 'Inspirativní'],
    love: 'Jako Architekt potřebuješ partnera, který stojí pevně na zemi, ale dokáže snít s Tebou. Ideální shoda: 4 (Stavitel), 8 (Vůdce), 6 (Pečovatel).',
  ...
  33: {
    ...
    traits: ['Bezpodmínečná láska', 'Léčivá přítomnost', 'Hluboká moudrost', 'Daří se ostatním v Tvé přítomnosti'],
    love: 'Jako Léčitel potřebuješ partnera, který je schopen přijmout hloubku Tvé lásky a opětovat ji. Ideální shoda: 6 (Pečovatel), 9 (Idealista), 11 (Vizionář).',
