...
export const ARCHETYPES: Record<number, Archetype> = {
  1: {
    ...
    description: 'Tvojí silou je nezávislost, kreativita a ambice. Miluješ výzvy a jdeš vlastní cestou. V lásce hledáš partnera, který Tě bude respektovat, ne řídit.',
    traits: ['Sebejistý', 'Kreativní', 'Přímý', 'Ambiciózní'],
    love: 'Potřebuješ prostor a respekt. Nejlépe se hodíš k někomu, kdo má vlastní svět, ne k někomu, kdo bude závislý na Tvé pozornosti.',
  ...
  2: {
    ...
    description: 'Tvojí silou je empatie, intuice a orientace na vztahy. Cítíš ostatní hlouběji než oni sami sebe. V lásce hledáš skutečnou duševní spřízněnost.',
    traits: ['Empatický', 'Intuitivní', 'Laskavý', 'Harmonický'],
    love: 'Potřebuješ jistotu a hlubší spojení. Nejlépe se hodíš k někomu klidnému a spolehlivému, kdo oceňuje Tvou citlivost.',
  ...
  3: {
    ...
    description: 'Tvojí silou je charisma, schopnost se vyjádřit a vnitřní energie. Umíš zaplnit každou místnost svou přítomností. V lásce potřebuješ partnera, se kterým nikdy nezažiješ nudu.',
    traits: ['Charismatický', 'Kreativní', 'Optimistický', 'Komunikativní'],
    love: 'Potřebuješ vzrušení a prostor se projevit. Nejlépe Ti sedne někdo, kdo Tě obdivuje a dává Ti prostor zářit.',
  ...
  4: {
    ...
    description: 'Tvojí silou je spolehlivost, smysl pro řád a věrnost. Stavíš na pevných základech — ve všem, co děláš. V lásce hledáš stabilitu a skutečný závazek.',
    traits: ['Spolehlivý', 'Disciplinovaný', 'Věrný', 'Praktický'],
    love: 'Potřebuješ bezpečí a předvídatelnost. Nejlépe se hodíš k někomu, kdo sdílí Tvé hodnoty a nebojí se budovat budoucnost krok za krokem.',
  ...
  5: {
    ...
    description: 'Máš v sobě svobodného ducha, chuť na změnu a hlad po nových zkušenostech. Nudíš se rutinou. V lásce potřebuješ partnera, který Tě drží za ruku, ale ne za krk.',
    traits: ['Svobodný', 'Adaptabilní', 'Zvídavý', 'Energický'],
    love: 'Potřebuješ prostor a dobrodružství. Nejlépe Ti sedne někdo, kdo Tě dokáže udržet — tím, že je sám zajímavý a nezávislý.',
  ...
  6: {
    ...
    description: 'Tvojí silou je laskavost, zodpovědnost a oddanost rodině. Tvůj domov je Tvůj chrám. V lásce dáváš více, než bereš — ale zasloužíš si obojí.',
    traits: ['Laskavý', 'Zodpovědný', 'Loajální', 'Ochranitelský'],
    love: 'Potřebuješ oceňování a reciprocitu. Nejlépe se hodíš k někomu, kdo umí přijímat lásku stejně hluboce, jako ji dávat.',
  ...
  7: {
    ...
    description: 'Tvojí silou je analytické myšlení, introspekce a hloubka. Hledáš pravdu pod povrchem věcí. V lásce potřebuješ partnera, který respektuje Tvou potřebu hloubky a samoty.',
    traits: ['Analytický', 'Spirituální', 'Klidný', 'Soustředěný'],
    love: 'Potřebuješ partnera, který respektuje Tvůj prostor a nesnaží se Tě zachránit. Nejlépe Ti sedne někdo, kdo má vlastní vnitřní svět.',
  ...
  8: {
    ...
    description: 'Tvojí silou je strategické myšlení, přirozená autorita a schopnost dotahovat věci do konce. Vytváříš svět kolem sebe, ne v něm. V lásce potřebuješ partnera, který sdílí Tvé ambice, ale není jimi pohlcen.',
    traits: ['Strategický', 'Autoritativní', 'Velkorysý', 'Disciplinovaný'],
    love: 'Potřebuješ partnera, který Tě respektuje a má vlastní cíle. Nejlépe se hodíš k někomu, kdo umí ocenit Tvou sílu i zranitelnost.',
  ...
  9: {
    ...
    description: 'Tvojí silou je soucit, vize a moudrost. Neseš v sobě esenci všech předchozích čísel — kus každého archetypu. V lásce hledáš někoho, s kým budeš sdílet větší smysl.',
    traits: ['Soucitný', 'Idealistický', 'Moudrý', 'Velkorysý'],
    love: 'Potřebuješ partnera, s kterým budeš sdílet smysl většího celku. Nejlépe se hodíš k někomu, kdo má hloubku, ale neutopí se v sebelítosti.',
  ...
  11: {
    ...
    description: 'Tvojí silou je hluboká intuice a neobyčejná citlivost. Cítíš věci, které ostatním unikají. V lásce hledáš partnera, který dokáže nést Tvou intenzitu a zároveň Ti pomáhá zůstat ukotvený/á.',
    traits: ['Intuitivní', 'Inspirativní', 'Citlivý', 'Spirituální'],
    love: 'Potřebuješ partnera, který Tě pochopí v tichosti — slov je málo. Nejlépe Ti sedne někdo, kdo má pevné nohy a otevřené srdce.',
  ...
  22: {
    ...
    description: 'Jsi master builder — vize spojená s praktickou realizací. Dokážeš proměnit sny v instituce, hnutí nebo trvalá díla. V lásce hledáš někoho, kdo s Tebou bude sdílet schopnost realizovat velké vize.',
    traits: ['Vizionářský', 'Praktický', 'Disciplinovaný', 'Inspirativní'],
    love: 'Potřebuješ partnera, který sdílí Tvou potřebu budovat něco většího. Nejlépe Ti sedne někdo, kdo rozumí, že Tvá práce je Tvůj způsob lásky.',
  ...
  33: {
    ...
    description: 'Jsi master teacher — Tvým darem je bezpodmínečná laskavost a léčivá přítomnost. V lásce hledáš partnera, který ocení Tvou laskavost a nebude ji vyčerpávat.',
    traits: ['Soucitný', 'Léčivý', 'Inspirativní', 'Nesobecký'],
    love: 'Potřebuješ partnera, s kterým budeš sdílet svou misi laskavosti — ne ho zachraňovat. Nejlépe Ti sedne někdo, kdo umí přijímat lásku stejně tak, jako ji rozdávat.',
