          ...
          <section>
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              <dl className="divide-y divide-gray-200">
                ...
                <div className="grid grid-cols-2 px-4 py-3"><dt className="text-gray-500">Cosmatch+ kvartálně</dt><dd className="font-medium text-gray-900">597 Kč / 90 dní <span className="text-emerald-600 text-sm">(199 Kč/měs · sleva 20 %)</span></dd></div>
                <div className="grid grid-cols-2 px-4 py-3"><dt className="text-gray-500">Cosmatch+ ročně</dt><dd className="font-medium text-gray-900">1 788 Kč / 365 dní <span className="text-emerald-600 text-sm">(149 Kč/měs · sleva 40 %)</span></dd></div>
                ...
                <div className="grid grid-cols-2 px-4 py-3"><dt className="text-gray-500">Cosmatch Serious kvartálně</dt><dd className="font-medium text-gray-900">987 Kč / 90 dní <span className="text-emerald-600 text-sm">(329 Kč/měs · sleva 18 %)</span></dd></div>
                <div className="grid grid-cols-2 px-4 py-3"><dt className="text-gray-500">Cosmatch Serious ročně</dt><dd className="font-medium text-gray-900">2 988 Kč / 365 dní <span className="text-emerald-600 text-sm">(249 Kč/měs · sleva 38 %)</span></dd></div>
