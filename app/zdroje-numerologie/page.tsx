...
const DESC = 'Cosmatch staví na 14 klíčových zdrojích numerologie a personology — od Pythagora přes Cheira, Florence Campbell, Juno Jordan a Matthewa Goodwina, k současným autorům jako Hans Decoz, Glynis McCants nebo Michelle Buchanan. Z české tradice cituje Jitku Kadlecovou a Ester Davidovou. Z mezinárodních autorů jsou česky dostupní Saffi Crawford a Geraldine Sullivan (Magická hra čísel a hvězd, Ikar 2002), Dan Millman (Čísla života, Eminent 2003, reissue Martinus 2017) a Helmut Kritzinger (Partnerství a numerologie, Pragma 1999, originál v němčině).'
