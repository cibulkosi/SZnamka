      ...
      <article className="max-w-2xl mx-auto px-6 pt-16 pb-24">
        ...
        <header className="mb-16">
          ...
          <p className="text-lg text-gray-700 leading-relaxed max-w-xl">
            Česká republika je dle průzkumů šestá nejzranitelnější země světa vůči romance scams.
            Cosmatch proto staví na dvou vrstvách ochrany, jejichž společným cílem
            je jediné: aby ses na cosmatch.cz nemusel/a bát.
          </p>
        </header>
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-[auto,1fr] gap-x-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-[1.75] text-[1.0625rem] mb-3">
                  ...
                  neviditelným testem, který odhaluje automatizované registrace. Boti se
                  k nám nedostanou.
                </p>
                <p className="text-gray-700 leading-[1.75] text-[1.0625rem]">Dále používáme další ochranu jako rate limiting na úrovni Cloudflare WAF, honeypot pole, IP throttling a další.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-[auto,1fr] gap-x-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-[1.75] text-[1.0625rem] mb-3">
                  Přihlášení je možné jen přes Google nebo Facebook, heslo u nás neexistuje.
                  Tyto účty navíc vyžadují reálné telefonní číslo, což je pro většinu botů
                  příliš drahá překážka.
                </p>
                <p className="text-sm text-gray-500 italic">Žádné e-maily od botů, žádné fake registrace.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6 text-gray-700 leading-[1.75] text-[1.0625rem]">
            ...
            <ol className="space-y-3 list-none ml-0">
              <li className="grid grid-cols-[auto,1fr] gap-4">
                ...
                <span>Profil je v řádech minut dočasně skrytý z feedu, dokud nezkontrolujeme platnost nahlášení.</span>
              </li>
              <li className="grid grid-cols-[auto,1fr] gap-4">
                <span className="serif text-pink-500 font-medium">02</span>
                <span>Pokud potvrdíme scam, účet trvale smažeme a zápisem do interní blacklist databáze předejdeme opakované registraci.</span>
              </li>
              <li className="grid grid-cols-[auto,1fr] gap-4">
                <span className="serif text-pink-500 font-medium">03</span>
                <span>Jednou měsíčně zveřejníme veřejně dostupné statistiky reportů — kolik účtů bylo zablokovaných.</span>
              </li>
            </ol>
          </div>
        </section>
