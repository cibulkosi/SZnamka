    ...
    <main className="min-h-screen bg-[#FAF6F0]">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          { "@type": "Question", "name": 'Je ID verifikace povinná?', "acceptedAnswer": { "@type": "Answer", "text": 'Ano, pro Cosmatch Serious (399 Kč/měs · ročně 249 Kč/měs). Pro Free a Cosmatch+ tier je verifikace volitelná. Bez ID verifikace nezískáš zelený štítek Ověřeno ani neuvidíš ostatní ověřené.' } },
