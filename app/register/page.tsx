        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-5 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">Potvrzení data narození</h3>
              <p className="text-pink-500 font-semibold text-xl mt-2">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 mb-6">
              <p className="text-amber-800 text-sm leading-relaxed text-center">
                ⚠️ Datum narození <strong>nelze po registraci změnit</strong> — je trvale svázáno s tvým personologickým profilem.
              </p>
            </div>
