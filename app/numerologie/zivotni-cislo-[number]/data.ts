// Auto-generated from SEO content plan — 12 life path archetypes
...
export const ARCHETYPES: Record<string, Archetype> = {
  "1": {
    ...
    "traits_pos": [
      ...
      "Přirozený leader",
      "Vytváří originální nápady",
      "Cílevědomý a vytrvalý"
    ],
    "traits_neg": [
      "Tendence k panovačnosti",
  ...
  "2": {
    ...
    "traits_pos": [
      ...
      "Skvělý posluchač",
      "Intuitivní vnímání lidí",
      "Trpělivý partner"
    ],
    "traits_neg": [
      "Občas se obětuje pro druhé",
  ...
  "3": {
    ...
    "traits_neg": [
      "Rozptýlený mezi mnoha projekty",
      "Občas povrchní",
  ...
  "5": {
    ...
    "short": "Číslo 5 je Dobrodruh — svobodný duch, který se nudí rutinou. Adaptivní, zvídavý, plný energie.",
    "traits_pos": [
      "Adaptabilní v každé situaci",
      "Komunikativní a vtipný",
      "Nadšení pro nové zkušenosti",
      "Otevřená mysl"
    ],
    "traits_neg": [
      "Strach ze závazku",
  ...
  "11": {
    ...
    "traits_neg": [
      "Vysoká citlivost vedoucí k přetížení",
      "Náchylný k úzkosti",
  ...
  "22": {
    ...
    "traits_pos": [
      ...
      "Disciplinovaný leader",
      "Inspirativní"
    ],
    "traits_neg": [
      "Obsese s dokonalostí",
      "Workoholismus",
  ...
  "33": {
    ...
    "traits_pos": [
      ...
      "Léčivá přítomnost",
      "Hluboká moudrost",
      "Daří se ostatním v jeho přítomnosti"
    ],
    "traits_neg": [
      "Dávání bez hranic",
      "Tendence k vyhoření",
