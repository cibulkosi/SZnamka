      ...
      <article className="max-w-2xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="space-y-12 text-gray-800 leading-[1.75] text-[1.0625rem]">
          ...
          <section>
            ...
            <p className="mb-3 pl-4">
              <strong className="text-gray-900 font-medium">Mgr. Ing. Simonou Cibulkovou</strong>, IČO 08419531, se sídlem Pnětluky, Česká republika, provozovatelkou webu cosmatch.cz a stejnojmenné webové aplikace (dále jen „<strong>Provozovatel</strong>" nebo „<strong>Cosmatch</strong>")
            </p>
            <p className="mb-3 pl-4">
        ...
        <footer className="mt-16 pt-12 border-t border-gray-200">
          <p className="text-xs text-gray-400 leading-relaxed">
            Mgr. Ing. Simona Cibulková · IČO 08419531 · Pnětluky, Česká republika · <a href="mailto:ahoj@cosmatch.cz" className="text-pink-500 underline">ahoj@cosmatch.cz</a>
            <br /><br />
