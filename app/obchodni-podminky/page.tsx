        ...
        <div className="space-y-12 text-gray-800 leading-[1.75] text-[1.0625rem]">
          ...
          <section>
            ...
            <p className="mb-3 pl-4">
              <strong className="text-gray-900 font-medium">Mgr. Ing. Simonou Cibulkovou</strong>, IČO 08419531, se sídlem Kurzova 2222/16, 155 00 Praha 5 - Stodůlky, Česká republika, datová schránka tttkfnk, provozovatelkou webu cosmatch.cz a stejnojmenné webové aplikace (dále jen „<strong>Provozovatel</strong>“ nebo „<strong>Cosmatch</strong>“)
            </p>
            <p className="mb-3 pl-4">
          ...
          <section>
            ...
            <p className="mb-3">
              <strong className="text-gray-900 font-medium">3.3</strong> Předplatné Cosmatch+ je dostupné výhradně v mobilní aplikaci Cosmatch pro iOS a Android. Platbu zpracovává a fakturu vystavuje <strong className="text-gray-900 font-medium">Apple Distribution International Ltd.</strong> (Irsko) pro iOS, respektive <strong className="text-gray-900 font-medium">Google Commerce Limited</strong> (Irsko) pro Android. Cosmatch nemá přístup k údajům o platební kartě Uživatele. Detail viz <a href="/opakovane-platby" className="text-pink-500 underline">Předplatné a platby</a>.
            </p>
            <p>
          ...
          <section>
            ...
            <p className="mb-3">
              <strong className="text-gray-900 font-medium">7.2</strong> Cosmatch algoritmus používá kombinaci klasické tradice kompatibility podle data narození (mj. astrologické vzorce) a moderních psychologických přístupů (typologie Myers-Briggs, teorie citové vazby, jazyky lásky) k odhadu strukturálního souznění mezi dvěma lidmi. <strong className="text-gray-900 font-medium">Žádný z těchto nástrojů sám o sobě není vědecky validován jako spolehlivý prediktor vztahových výsledků.</strong> Cosmatch shoda je interpretační nástroj, ne predikce. Žádná aplikace nedokáže garantovat úspěch vztahu — záleží na vás, jak ho dokážete vybudovat.
            </p>
            <p className="mb-3">
