...
const OFFER_JSONLD = {
  ...
  '@type': 'Product',
  name: 'Cosmatch+',
  description: 'Předplatné numerologické seznamky Cosmatch — neomezené lajky, hloubková analýza podle data narození, vidíš kdo tě lajknul/a, prioritní zobrazení ve feedu.',
