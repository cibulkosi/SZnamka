      ...
      <article className="max-w-2xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="space-y-12 text-gray-800 leading-[1.75] text-[1.0625rem]">
          ...
          <section className="bg-emerald-50 border border-emerald-200 rounded-3xl p-8">
            ...
            <p>
              Máš právo odstoupit od předplatného Cosmatch+ <strong className="text-gray-900 font-medium">do 14 dnů</strong> od jeho uzavření. Předplatné se kupuje výhradně přes <strong className="text-gray-900 font-medium">Apple App Store</strong> nebo <strong className="text-gray-900 font-medium">Google Play</strong>, takže refund vyřizují přímo tyto platformy.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Refund proběhne na původní platební prostředek do 5–10 pracovních dní od schválení Apple, respektive Google.</li>
